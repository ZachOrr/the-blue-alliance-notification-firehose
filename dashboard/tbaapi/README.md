# tbaapi
A client library for accessing The Blue Alliance API v3

## Usage
First, create a client:

```python
from tbaapi import Client
...
```python
from tbaapi import AuthenticatedClient
...
```python
from tbaapi.models import MyDataModel
from tbaapi.api.my_tag import get_my_data_model
from tbaapi.types import Response
...
1. Any endpoint which did not have a tag will be in `tbaapi.api.default`
