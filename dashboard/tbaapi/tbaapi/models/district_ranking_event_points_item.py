...
T = TypeVar("T", bound="DistrictRankingEventPointsItem")


@_attrs_define
class DistrictRankingEventPointsItem:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        district_cmp = self.district_cmp
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        district_cmp = d.pop("district_cmp")
        ...
        district_ranking_event_points_item = cls(
            district_cmp=district_cmp,
            total=total,
            alliance_points=alliance_points,
            elim_points=elim_points,
        ...
        district_ranking_event_points_item.additional_properties = d
        return district_ranking_event_points_item
