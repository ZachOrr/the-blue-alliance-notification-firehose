...
T = TypeVar("T", bound="MatchScoreBreakdown2016")
...
class MatchScoreBreakdown2016:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        blue = MatchScoreBreakdown2016Alliance.from_dict(d.pop("blue"))

        red = MatchScoreBreakdown2016Alliance.from_dict(d.pop("red"))

        match_score_breakdown_2016 = cls(
            blue=blue,
            red=red,
        )

        match_score_breakdown_2016.additional_properties = d
        return match_score_breakdown_2016
