...
T = TypeVar("T", bound="GetTeamEventsStatusesByYearResponse200")


@_attrs_define
class GetTeamEventsStatusesByYearResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        get_team_events_statuses_by_year_response_200 = cls()
        ...
        get_team_events_statuses_by_year_response_200.additional_properties = additional_properties
        return get_team_events_statuses_by_year_response_200
