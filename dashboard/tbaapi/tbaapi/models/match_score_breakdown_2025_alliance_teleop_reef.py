...
T = TypeVar("T", bound="MatchScoreBreakdown2025AllianceTeleopReef")


@_attrs_define
class MatchScoreBreakdown2025AllianceTeleopReef:
    """
    Attributes:
        top_row (ReefRow2025):
        mid_row (ReefRow2025):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        match_score_breakdown_2025_alliance_teleop_reef = cls(
            top_row=top_row,
            mid_row=mid_row,
            bot_row=bot_row,
            trough=trough,
        ...
        match_score_breakdown_2025_alliance_teleop_reef.additional_properties = d
        return match_score_breakdown_2025_alliance_teleop_reef
